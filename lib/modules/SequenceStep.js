...
class SequenceStep {
    constructor(id, mediaList, startTime, endTime, size, layout) {
        this.id = id;
    ...
    generateFilter() {
        ...
        const videoList = this.mediaList.filter(media => media.hasVideo ||
            (media.hasAudio &&
                !media.hasVideo &&
                !this.mediaList.some(other => { var _a, _b; return other.hasVideo && media.user && ((_a = other.user) === null || _a === void 0 ? void 0 : _a.id) === ((_b = media.user) === null || _b === void 0 ? void 0 : _b.id); })));
        ...
        videoList.forEach((vid, ind) => {
            ...
            if (vid.hasVideo) {
                ...
                out.push(`color=s=${this.size.w}x${this.size.h}:c=green@1.0,trim=0:${this.duration / 1000},drawtext=text='${(_a = vid.user) === null || _a === void 0 ? void 0 : _a.name}':x=(w-tw)/2:y=((h-th)/2):fontcolor=black:fontsize=55,`);
            }
            // scale fit in box
